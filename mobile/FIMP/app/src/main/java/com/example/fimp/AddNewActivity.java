...
import com.example.fimp.Network_Utility.ApiConfig;
import com.example.fimp.Network_Utility.AppConfig;
import com.example.fimp.Network_Utility.ServerResponse;
...
public class AddNewActivity extends AppCompatActivity implements View.OnClickListener {
                            ...
                            public void onSelection(MaterialDialog dialog, View view, int which, CharSequence text) {
                                switch (which) {
                                    ...
                                    case 1:
                                        ...
                                        break;
                                    case 2:
                                        imageView.setImageResource(R.drawable.face_scan);
                                        break;
                                }
                            }
                        })
    ...
    private void uploadFile() {
        ...
        if (postPath == null || postPath.equals("")) {
            ...
            Call<ServerResponse> call = getResponse.uploadPerson("token",nameBody, map);
